...
import { getOccasionByName, createOccasion } from '../../../services/ApiServices';
...
const AddEditOccasion = () => {
  ...
  const handleUpdateOccasion = (e) => {
    ...
    if (handleValidate()) {
      ...
      createOccasion(createOccasionObj)
        .then((res) => {
          let { status, data } = resHandle(res);
          setIsSubmit(false);
          if (status === 200) {
        ...
        <form className="form-controller chosen">
          <div className="form-group row">
            ...
            <div className="col">
              ...
              <input
                ...
                value={occasionTitle}
                name="topicName"
                onChange={(e) => (setOccasionTitle(e.target.value), setOccasionTitleErr(''))}
              />
              {occasionTitleErr && <div className="inlineerror">{occasionTitleErr} </div>}
            </div>
          </div>
          ...
          <div className="form-group row">
            <div className="col">
              ...
              <input
                ...
                value={occasionOrder}
                name="topicName"
                onChange={(e) => (setOccasionOrder(e.target.value), setOccasionOrderErr(''))}
              />

              {occasionOrderErr && <div className="inlineerror">{occasionOrderErr} </div>}
            </div>
            <div className="col">
              <label>Status</label>
              <select
                ...
                onChange={(e) => (setOccasionStatus(e.target.value), setOccasionStatusErr(''))}
              >
                <option value="true">Activate</option>
                <option value="false">De-Activate</option>
              </select>
              {occasionStatusErr && <div className="inlineerror">{occasionStatusErr} </div>}
            </div>
          </div>
          ...
          <div className="form-group row">
            <div className="col">
              ...
              <input
                ...
                value={occasionDesc}
                name="topicName"
                onChange={(e) => (setOccasionDesc(e.target.value), setOccasionDescErr(''))}
              />
              {occasionDescErr && <div className="inlineerror">{occasionDescErr} </div>}
            </div>
          </div>
          <div className="form-group row">
            <div className="col">
              ...
              <select
                ...
                name="occassionType"
                value={occasionType}
                onChange={(e) => (setOccasionType(e.target.value), setOccasionTypeErr(''))}
              >
                <option value="private">Private</option>
                <option value="public">Public</option>
                <option value="wishes">Wishes</option>
              </select>
              {occasionTypeErr && <div className="inlineerror">{occasionTypeErr} </div>}
            </div>
            <div className="col">
              ...
              {lottieBackgroundBase64 && (
                <a
                  href={lottieBackgroundBase64}
                  download={
                    lottieBackgroundBase64.includes('https://') ? lottieBackgroundBase64 : lottieBackgroundFileName
                  }
                  target="blank"
                >
                  {' '}
          ...
          <div className="form-group row">
            <div className="col">
              ...
              >
                {' '}
                {textColor ? textColor : 'Click here'}
              </div>
              {textColorErr ? <div className="inlineerror">{textColorErr} </div> : ''}
            ...
            <div className="col">
              ...
              >
                {' '}
                {backgroundColor ? backgroundColor : 'Click here'}
              </div>
              {backgroundColorErr ? <div className="inlineerror">{backgroundColorErr} </div> : ''}
          ...
          <div className="form-group row">
            ...
            <div className="col">
              <div className="rounded-sm pb-3">
                ...
                {visibilityErr && <div className="inlineerror">{visibilityErr} </div>}
              </div>
            </div>
          </div>
          <div className="form-grop row">
            <div className="col">{base64 ? <img className="iconImg" src={base64} alt="icon" /> : ''}</div>
