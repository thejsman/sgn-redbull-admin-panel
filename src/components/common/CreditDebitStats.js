				...
				<div className="row">
					<div className="col-sm-12 dash_sm_card ">
						<Ticker
							...
							prefix="₹ "
							start={props.principalAmount[1]}
							end={props.creditData.principalAmount}
						/>
					</div>
				</div>
				<div className="row">
					<div className="col-sm-6 dash_sm_card">
						<Ticker
							title="Total Reward Earned By Users"
							prefix="₹ "
							start={props.tolCreditAmount[1]}
							end={props.creditData.totalAmount}
						/>
					</div>
					<div className="col-sm-6 dash_sm_card">
						<Ticker
							title="Total Monthly Reward Earned By Users"
							prefix="₹ "
							start={props.tolMonthCreditAmount[1]}
							end={props.creditData.monthAmount}
						/>
					</div>
				</div>
				<div className="row">
					<div className="col-sm-6 dash_sm_card">
						<Ticker
							title="Total Revenue"
							prefix="₹ "
							start={props.tolDebitAmount[1]}
							end={props.debitData.totalAmount}
						/>
					</div>
					<div className="col-sm-6 dash_sm_card">
						<Ticker
							...
							prefix="₹ "
							start={props.tolMonthDebitAmount[1]}
							end={props.debitData.monthAmount}
						/>
					</div>
				</div>
			</div>
