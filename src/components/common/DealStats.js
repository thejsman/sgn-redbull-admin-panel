			...
			<div className="col-sm-6 mt-3">
				<div className="row">
					<div className="col-sm-6 dash_sm_card ">
						<Ticker
							title="Total Deal Orders Amount"
							start={props.tolDealAmount[1]}
							end={props.totalAmount}
						/>
					</div>
					<div className="col-sm-6 dash_sm_card">
						<Ticker
							title="Monthly Deal Orders Amount"
							start={props.tolMonthDealAmount[1]}
				...
				<div className="row">
					<div className="col-sm-6 dash_sm_card ">
						<Ticker
							title="Total Deal Orders"
							start={props.tolDealOrder[1]}
							end={props.totalOrder}
						/>
					</div>
					<div className="col-sm-6 dash_sm_card">
						<Ticker
							title="Monthly  Deal Orders"
							start={props.tolMonthDealOrder[1]}
